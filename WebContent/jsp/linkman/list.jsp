										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/linkman/toEdit.action?lkmId=${linkman.lkmId}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/linkman/delete.action?lkmId=${linkman.lkmId}">删除</a>
													</TD>
