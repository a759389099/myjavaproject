...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/role/list.action"
		method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：系统管理 &gt; 角色列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 value="${queryVo.role.roleName}" name="role.roleName"></TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>${role.roleMemo}</TD>
													<TD>
													<a href="${pageContext.request.contextPath }/role/toEdit.action?roleId=${role.roleId}">修改</a>
													<a href="${pageContext.request.contextPath }/role/delete.action?roleId=${role.roleId}">删除</a>
													</TD>
												</TR>
