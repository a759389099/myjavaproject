...
<BODY>
	<FORM id=form1 name=form1
		...
		<!-- 隐藏域回显当前编辑的拜访记录id -->
		<input  type="hidden"  name="visitId" <%-- value="<s:property value="#saleVisit.visit_id" --%> />"  />
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<input type="text"  style="WIDTH: 180px" disabled="disabled" id="custName" />
								...
								<td  >
									<INPUT class=textbox id="visit_time" type="text" 
														style="WIDTH: 180px" maxLength=50 name="visitTime" readonly="readonly"  />
								</td>
							</TR>
							...
							<TR>
								...
								<INPUT class=textbox id=sChannel2 type="text"
														style="WIDTH: 180px" maxLength=50 name="visitInterviewee"  />
								</td>
								<td>拜访地址：</td>
								<td>
							...
							<TR>
								...
								<INPUT class=textbox id="visit_nexttime" readonly="readonly"
														style="WIDTH: 180px" maxLength=50 name="visitNexttime" />
								</td>
							</TR>
							<tr>
								<td rowspan=2>
